# ![Location](src/main/res/drawable-xhdpi/ic_launcher.png) Location [![Build Status](https://travis-ci.org/billthefarmer/location.svg?branch=master)](https://travis-ci.org/billthefarmer/location)
